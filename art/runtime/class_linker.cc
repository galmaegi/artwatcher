...
// h4cker
// ALOGV("class_linker.cc enter_interpreter : %d",enter_interpreter);

  if (enter_interpreter && !method->IsNative()) {
    method->SetEntryPointFromInterpreter(interpreter::artInterpreterToInterpreterBridge);
// ALOGV("method->SetEntryPointFromInterpreter(interpreter::artInterpreterToInterpreterBridge);");
  } else {
    method->SetEntryPointFromInterpreter(artInterpreterToCompiledCodeBridge);
// ALOGV("method->SetEntryPointFromInterpreter(artInterpreterToCompiledCodeBridge);");
  }

  if (method->IsAbstract()) {
    method->SetEntryPointFromQuickCompiledCode(GetQuickToInterpreterBridge());
// ALOGV("method->SetEntryPointFromQuickCompiledCode(GetQuickToInterpreterBridge());");
#if defined(ART_USE_PORTABLE_COMPILER)
    method->SetEntryPointFromPortableCompiledCode(GetPortableToInterpreterBridge());
#endif
    return;
...
// ALOGV("method->SetEntryPointFromQuickCompiledCode(GetQuickResolutionTrampoline());");
#if defined(ART_USE_PORTABLE_COMPILER)
...
// ALOGV("method->SetEntryPointFromQuickCompiledCode(GetQuickGenericJniTrampoline());");
#if defined(ART_USE_PORTABLE_COMPILER)
...
// ALOGV("method->SetEntryPointFromQuickCompiledCode(GetQuickToPortableBridge());");
#endif
  } else {
    DCHECK(method->GetEntryPointFromQuickCompiledCode() != nullptr);
// ALOGV("DCHECK(method->GetEntryPointFromQuickCompiledCode() != nullptr);");
#if defined(ART_USE_PORTABLE_COMPILER)
    method->SetEntryPointFromPortableCompiledCode(GetPortableToQuickBridge());
#endif
  }
...
// ALOGV("method->UnregisterNative(Thread::Current());");
